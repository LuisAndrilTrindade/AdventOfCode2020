...
input = ["light plum bags contain 1 faded blue bag.",
         ...
         "wavy gray bags contain 2 dotted teal bags.", "wavy tan bags contain 2 plaid aqua bags.",
         ...
         "dark olive bags contain 2 bright cyan bags.", "dotted orange bags contain 2 pale lime bags.",
         ...
         "dull black bags contain 2 shiny teal bags.", "shiny coral bags contain 4 posh blue bags, 1 dotted coral bag.",
         ...
         "dark tomato bags contain 5 clear brown bags.", "shiny indigo bags contain 3 pale orange bags.",
         ...
         "posh violet bags contain 5 dim purple bags.", "mirrored chartreuse bags contain 1 dark bronze bag.",
         ...
         "bright beige bags contain 5 dotted coral bags.", "drab tomato bags contain no other bags.",
         "pale beige bags contain 3 drab bronze bags.", "dotted aqua bags contain 5 plaid yellow bags.",
         ...
         "light indigo bags contain no other bags.", "shiny silver bags contain 2 dim maroon bags.",
         ...
         "light orange bags contain 1 plaid gold bag, 5 shiny coral bags.", "faded red bags contain 3 bright tan bags.",
         "wavy violet bags contain 5 plaid chartreuse bags.", "dim violet bags contain 1 pale lavender bag.",
         ...
         "clear tan bags contain 4 dotted black bags.", "dull tan bags contain 1 posh maroon bag, 1 dotted coral bag.",
         ...
         "faded tomato bags contain 2 bright teal bags.", "faded violet bags contain 2 plaid salmon bags.",
         ...
         "bright purple bags contain 2 light cyan bags.", "dull brown bags contain 3 bright white bags.",
         ...
         "shiny purple bags contain 5 clear black bags.", "muted blue bags contain 4 dotted indigo bags.",
         ...
         "pale coral bags contain 5 dim gold bags.", "clear red bags contain 4 muted maroon bags.",
         ...
         "wavy tomato bags contain 5 posh turquoise bags.", "wavy white bags contain 2 dim maroon bags.",
         ...
         "mirrored lime bags contain 5 vibrant coral bags.", "light black bags contain 2 dark salmon bags.",
         ...
         "plaid bronze bags contain 2 vibrant maroon bags.", "striped crimson bags contain 1 shiny beige bag.",
         ...
         "muted turquoise bags contain 4 shiny beige bags.", "posh maroon bags contain 2 light lime bags.",
         ...
         "drab magenta bags contain 3 plaid chartreuse bags.", "pale black bags contain no other bags.",
         "dark fuchsia bags contain 1 dim yellow bag, 5 dim salmon bags.", "clear gray bags contain 3 bright tan bags.",
         "dark purple bags contain 4 plaid purple bags, 1 dark gold bag.", "bright tan bags contain no other bags.",
         ...
         "muted crimson bags contain 5 light indigo bags.", "drab fuchsia bags contain 3 shiny coral bags.",
         "light lime bags contain 4 bright lavender bags, 2 light crimson bags, 5 vibrant blue bags.",
         "dotted yellow bags contain 4 pale fuchsia bags.", "bright lavender bags contain no other bags.",
         ...
         "drab red bags contain 5 striped tomato bags.", "bright salmon bags contain 3 light indigo bags.",
         ...
         "clear fuchsia bags contain 5 dotted indigo bags.", "dark bronze bags contain 4 shiny black bags.",
         "dotted olive bags contain 4 bright cyan bags.", "vibrant purple bags contain 3 striped gray bags.",
         ...
         "pale orange bags contain 5 drab blue bags.", "shiny crimson bags contain 3 light crimson bags.",
         ...
         "posh gray bags contain 2 light crimson bags.", "dotted blue bags contain 2 posh tan bags.",
         ...
         "pale indigo bags contain no other bags.", "drab lime bags contain 2 mirrored turquoise bags.",
         ...
         "dark tan bags contain 2 drab lavender bags.", "faded lavender bags contain 1 vibrant blue bag.",
         ...
         "wavy magenta bags contain 4 dim purple bags, 2 dark aqua bags.", "drab black bags contain 2 light plum bags.",
         ...
         "plaid coral bags contain 2 mirrored cyan bags.", "plaid cyan bags contain 4 pale indigo bags.",
         ...
         "light maroon bags contain 2 vibrant bronze bags.", "bright brown bags contain 2 wavy yellow bags.",
         ...
         "wavy yellow bags contain 3 muted magenta bags.", "muted purple bags contain 1 dull chartreuse bag.",
         ...
         "striped tomato bags contain 5 drab white bags.", "muted teal bags contain 5 shiny lime bags.",
         ...
         "dim red bags contain 5 pale magenta bags.", "dark green bags contain 5 muted cyan bags, 3 faded brown bags.",
         ...
         "striped teal bags contain 3 mirrored silver bags.", "striped green bags contain 1 muted teal bag.",
         "vibrant teal bags contain 3 muted indigo bags.", "shiny turquoise bags contain 3 dull chartreuse bags.",
         ...
         "clear purple bags contain 5 shiny black bags.", "dim silver bags contain 4 clear brown bags.",
         "bright black bags contain 4 posh fuchsia bags.", "shiny plum bags contain 1 mirrored cyan bag.",
         "striped lavender bags contain 3 pale lavender bags, 4 muted cyan bags.",
         "drab tan bags contain no other bags.", "bright olive bags contain 3 muted coral bags.",
...
for rule in input:
    inner_bags = {}
    split = rule.replace(" bags", "").replace(" bag", "").replace(".", "").split(" contain ")
    main_bag = split[0]

    for inner_bag in split[1].split(", "):
        amount = inner_bag.split(" ")[0]
        if amount == "no":
            continue
        bag = inner_bag[len(amount) + 1:]
        inner_bags[bag] = int(amount)
...
def can_contain(bag_color, contain):
    for bag in bags:
        if bag_color in bags[bag].keys() and bag not in contain:
            contain.append(bag)
            can_contain(bag, contain)


can_contain(start, contain)
print(len(contain))
...
def total_bags(bag_color, mult=1):
    if len(bags[bag_color]) == 0:
        return mult
    else:
        for bag in bags[bag_color]:
            total.append(mult * bags[bag_color][bag])
            total_bags(bag, mult * bags[bag_color][bag])
